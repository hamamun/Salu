...
const List<List<String>> _countryTable = <List<String>>[
  ...
  <String>['Anguilla', 'ai', 'aia'],
  <String>['Antigua and Barbuda', 'ag', 'atg'],
  ...
  <String>['Côte d\'Ivoire', 'ci', 'civ', 'ivory coast'],
  ...
  <String>['Saint Barthélemy', 'bl', 'blm'],
  <String>['Saint Kitts and Nevis', 'kn', 'kna'],
  <String>['Saint Lucia', 'lc', 'lca'],
  <String>['Saint Martin', 'mf', 'maf'],
  <String>['Saint Pierre and Miquelon', 'pm', 'spm'],
  ...
  <String>['Turks and Caicos Islands', 'tc', 'tca'],
  ...
  <String>['United States Virgin Islands', 'vi', 'vir'],
  ...
  <String>['Wallis and Futuna', 'wf', 'wlf'],
  <String>['Western Sahara', 'eh', 'esh'],
  <String>['Yemen', 'ye', 'yem'],
  <String>['Zambia', 'zm', 'zmb'],
  <String>['Zimbabwe', 'zw', 'zwe'],
  <String>['Åland Islands', 'ax', 'ala'],
];
